...
/**
 * This is the item provider adapter for a {@link idm.mm.fil.mm.Personne} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonneItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Personne_name_feature",
								"_UI_Personne_type"),
						MmPackage.Literals.PERSONNE__NAME, true, false, false,
	...
	protected void addEmailPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Personne_email_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Personne_email_feature",
								"_UI_Personne_type"),
						MmPackage.Literals.PERSONNE__EMAIL, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case MmPackage.PERSONNE__NAME:
		case MmPackage.PERSONNE__EMAIL:
